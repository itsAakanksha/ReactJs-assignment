    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row w-full mx-auto relative gap-5 my-4">
      ...
      <div className="md:w-2/3 p-6 flex">
        ...
        <p className="text-gray-700 text-sm mb-4">
          <span className='font-bold'>Wix pro 27 inch Responsive website Builder - </span>
          Comprehensive Digital platform creation tool Stramedline design interface for professional website and online stores
          <br />
        ...
        <button className="bg-blue-500 text-white py-2 px-4 rounded-lg mx-2 hover:bg-blue-700">
          Learn More
        </button>
      </div>
